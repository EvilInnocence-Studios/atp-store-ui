import { faArrowUpRightFromSquare, faCartPlus, faDownload, faUserPlus } from "@fortawesome/free-solid-svg-icons";
...
export const AddtoCartBtnComponent = ({product, addToCart, download, subscribe, brokeredLink}:AddtoCartBtnProps) => <>
