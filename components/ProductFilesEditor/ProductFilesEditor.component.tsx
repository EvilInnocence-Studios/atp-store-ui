...
export const ProductFilesEditorComponent = overridable(({ files, isLoading, folder, setFolder, add, remove, download, classes = styles }: ProductFilesEditorProps) =>
    <Spin spinning={isLoading}>
        <Row gutter={32} className={classes.productFilesEditor}>
            <Col xs={6} className={classes.folder}>
            ...
            <Col xs={18} className={classes.files}>
